...
<head>
    ...
    <style>
        ...
        .electronics-choice input[type="checkbox"] {
            margin-right: 5px;
            zoom: 1.5;
        }

        .electronics-choice button {
        ...
        .electronics-choice button:hover {
...
<body>
    ...
    <div class="electronics-container">
        <div class="hero">
            <h1>Electronics</h1>
            <div class="electronics-choice"> 
                <label for="Mobile-Devices">
                    <input type="checkbox" name="category" id="Mobile-Devices" value="mobile-devices"> Mobile Devices
                </label>
                <label for="Computers&Accessories">
                    <input type="checkbox" name="category" id="Computers&Accessories" value="computers-&-accessories"> Computers & Accessories
                </label>
                <label for="HomeAppliances">
                    <input type="checkbox" name="category" id="HomeAppliances" value="home-appliances"> Home Appliances
                </label>
                <label for="TV&Audio">
                    <input type="checkbox" name="category" id="TV&Audio" value="tv-&-audio"> TV & Audio
                </label>
                <label for="Gaming">
                    <input type="checkbox" name="category" id="Gaming" value="gaming"> Gaming
                </label>

...
<head>
    ...
    <style>
        ...
        .furniture-choice input[type="checkbox"] {
            margin-right: 5px;
            zoom: 1.5;
        }

        .furniture-choice button {
...
<body>
    ...
    <div class="furniture-container">
       <div class="hero">
            <h1>Furniture</h1>
            <div class="furniture-choice"> 
                <label for="LivingRoom">
                    <input type="checkbox" name="category" id="LivingRoom" value="living-room"> Living Room
                </label>
                <label for="Bedroom">
                    <input type="checkbox" name="category" id="Bedroom" value="bedroom"> Bedroom
                </label>
                <label for="DiningRoom">
                    <input type="checkbox" name="category" id="DiningRoom" value="dining-room"> Dining Room
                </label>
                <label for="OfficeFurniture">
                    <input type="checkbox" name="category" id="OfficeFurniture" value="office-furniture"> Office Furniture
                </label>
                <label for="Outdoor&Patio">
                    <input type="checkbox" name="category" id="Outdoor&Patio" value="outdoor-&-patio"> Outdoor & Patio
                </label>
                ...
                if($result->num_rows > 0)
                {
                    while($row= $result->fetch_assoc())
                    {
                        ...
                        echo '<div class="category">
                                    <img src="'.$imageSrc.'" alt="furniture"width="100" >

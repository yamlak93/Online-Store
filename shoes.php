...
<head>
    ...
    <style>
        ...
        .shoes-choice input[type="checkbox"] {
            margin-right: 5px;
            zoom: 1.5;
        }
    ...
    <div class="shoes-container">
        <div class="hero">
            ...
            <div class="shoes-choice">
                <label for="men-shoes">
                    <input type="checkbox" name="category" id="men-shoes" value="men's-shoes"> Men Shoes
                </label>
                <label for="female-shoes">
                    <input type="checkbox" name="category" id="female-shoes" value="women's-shoes"> Female Shoes  
                </label>
                <label for="sport-shoes">
                    <input type="checkbox" name="category" id="sport-shoes" value="sports-&-outdoor-shoes"> Sports & Outdoor Shoes
                </label>
                <label for="child-shoes">
                    <input type="checkbox" name="category" id="child-shoes" value="kids'-shoes"> Child Shoes
                </label>
                    ...
                    if($result->num_rows > 0)
                    {
                        while($row = $result->fetch_assoc())
                        {
                            ...
                            echo '<div class="category">
                                        <img src="'.$imageSrc.'" alt="Shoes" width="100">
